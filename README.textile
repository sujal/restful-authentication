...
* --haml: Generate HAML views rather than erb ones. This requires the 
    "HAML plugin":http://github.com/nex3/haml/ and Gem.
  It does not create haml ActionMailer views as these tend to be problematic.
